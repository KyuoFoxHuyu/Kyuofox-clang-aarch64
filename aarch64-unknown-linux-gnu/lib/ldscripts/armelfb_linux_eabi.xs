...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("/root/toolchains/tc-build/installTmp/aarch64-unknown-linux-gnu/lib"); SEARCH_DIR("/root/toolchains/tc-build/installTmp/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
